// WebSocket Connection Manager - Handles Socket.IO client connections and event routing
class WebSocketManager {
    ...
    // Connect to server and initialize Socket.IO
    ...
    // Load Socket.IO library dynamically from server
    loadSocketIO(url) {
        return new Promise((resolve, reject) => {
    ...
    setupListeners() {
        ...
        // Room and user management events
        ...
        // Remote cursor positioning for live collaboration
        this.socket.on('cursor-move', (data) => this.emit('remote-cursor-move', data));

        // Undo/Redo command events
